...
```text
release-assets/v2.0.0-ashfall-standalone-engine-edition-beta/
```
...
This beta is a graph-first playable vertical slice for runtime, install, repair, launch, and content graph evidence. It includes the current 12-module standalone verification slice and preserves strict artifact and content graph behavior.

...
- Pack manifest: `ashfall-standalone-engine-edition-beta-2.0.0-beta.2.pack.json`
- Pack artifact: `ashfall-standalone-engine-edition-2.0.0-beta.2.zip`
...
```text
java -Dfile.encoding=UTF-8 -jar echo-standalone-engine-2.0.0-beta.2.jar --pack-root <installRoot> --manifest pack.json --save-root <installRoot>/saves
```
